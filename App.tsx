          ...
          <div className="max-w-7xl mx-auto">
            ...
            <div className="bg-dark text-white rounded-[3rem] p-12 md:p-24 flex flex-col md:flex-row items-center gap-16 shadow-3xl">
              ...
              <div className="w-full md:w-1/3 aspect-square rounded-[2rem] overflow-hidden">
                <img src="https://images.unsplash.com/photo-1515377905703-c4788e51af15?auto=format&fit=crop&q=80&w=800" className="w-full h-full object-cover grayscale opacity-50 hover:grayscale-0 hover:opacity-100 transition-all duration-700" alt="Détente" />
              </div>
            </div>
          </div>
        </section>
    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[100svh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0 scale-105">
          <img 
            src="https://images.unsplash.com/photo-1596178065887-1198b6148b2b?auto=format&fit=crop&q=80&w=2000" 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
            ...
            <div className="relative">
              <div className="aspect-[3/4] rounded-3xl overflow-hidden shadow-2xl scale-95 hover:scale-100 transition-transform duration-700">
                <img src="https://images.unsplash.com/photo-1544161515-4ab6ce6db874?auto=format&fit=crop&q=80&w=1000" className="w-full h-full object-cover" alt="Soin Bianco" />
              </div>
